...
function Cards() {
  return (
    <section className=' container mx-auto sm:mx-auto grid sm:grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-3  items-center py-10 mb-10'>
        <div className='w-full h-full bg-cool-yellow rounded-3xl p-7 flex flex-col justify-center hover:bg-omo-yellow hover:drop-shadow-xl hover:-translate-y-5 hover:ease-in-out'>
        ...
        <div className='w-full h-full bg-cool-purple rounded-3xl p-7 flex flex-col justify-center hover:bg-omo-purple hover:drop-shadow-xl hover:-translate-y-5 hover:ease-in-out'>
        ...
        <div className='w-full h-full bg-cool-pink rounded-3xl p-7 hover:bg-omo-pink hover:drop-shadow-xl hover:-translate-y-5 hover:ease-in-out'>
